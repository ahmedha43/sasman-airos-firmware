...
<script type="text/javascript" src="/251204.1902/index.js"></script>
<script type="text/javascript" src="/251204.1902/js/jquery.ui.js"></script>
<? if ($is_password_change) { >
<script type="text/javascript" src="/251204.1902/js/pstrength.js"></script>
<? } >
...
<form enctype="multipart/form-data" id="loginform" method="post" action="<?echo htmlspecialchars($PHP_SELF);>">
	<tr>
		<td valign="top"><img src="/251204.1902/images/airos_logo.png"></td>
		<td class="loginsep">
...
<footer class="footer">
	<div class="umobileSection">
		<div class="mobileView">
			<img class="umobile" src="/251204.1902/images/unms.svg">&nbsp;
			...
			<img class="badge gplay" src="/251204.1902/images/gplay.svg" alt="GooglePlay"></a>&nbsp;
			<a href="https://itunes.apple.com/us/app/umobile-ubnt/id1183022489?mt=8">
			<img class="badge" src="/251204.1902/images/astore.svg" alt="AppleStore"></a>
		</div>
