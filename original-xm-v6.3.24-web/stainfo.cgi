...
$sta_mac = htmlspecialchars($sta_mac);
...
<script type="text/javascript" src="jsl10n.cgi?l=<? echo $lng; >&v=/251204.1902"></script>
<script type="text/javascript">

var ab5BeamAngles = [
'<img src="/251204.1902/images/ab5-p39.png" title="+39 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-p26.png" title="+26 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-p13.png" title="+13 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-0.png" title="0 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-m13.png" title="-13 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-m26.png" title="-26 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-m39.png" title="-39 <? echo dict_translate("degrees");>">',
'<img src="/251204.1902/images/ab5-bcast.png" title="bcast">',
];

var si_global = {
	'mode' : '<? echo _esc($mode); >',
	'ifname' : '<? echo _esc($ifname); >',
	'sta_mac' : '<? echo _esc($sta_mac); >',
	'autoack' : ('<? echo $autoack; >' == 'enabled'),
	'airmax_on' : <? echo _esc($airmax_on); >,
	'phased_array' : ("<? echo intval($feature_phased_array); >" == "1"),
	'beam_angles' : ab5BeamAngles, /* Currently we only have Airbeam-5, need selectivty in future */
	'_' : '_'
};

var kick_url = "stakick.cgi?staif=<? echo _esc($ifname);>&staid=<? echo _esc($sta_mac);>";

</script>
<script type="text/javascript" src="/251204.1902/signal.js"></script>
<script type="text/javascript" src="/251204.1902/stainfo.js"></script>
