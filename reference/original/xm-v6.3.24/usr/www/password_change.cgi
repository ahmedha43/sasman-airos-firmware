...
<col width="20%" />
	...
	<tr>
		<td colspan="3"><font color="red"><label><? echo dict_translate("msg_passwd_default|Default Password must be changed to apply configuration changes!"); ></label></td>
	</tr>
	<tr>
		<td colspan="3"><input type="hidden" name="adminname" id="dlgAdminname" value="<?echo htmlspecialchars($dlgAdminname)>"></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr class="passwdchange">
		...
		<td><input type="password" autocomplete="off" class="config i_adminpasswd" name="OldPassword" id="dlgOldPassword" maxlength="63" realname="<? echo dict_translate("Current Password"); >">
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	...
	<tr class="passwdchange">
		...
		<td>
			<input type="password" class="config i_adminpasswd" name="NewPassword" id="dlgNewPassword" maxlength="63" realname="<? echo dict_translate("New Password"); >">
		</td>
		<td>
	...
	<tr class="passwdchange">
		...
		<td>
			<input type="password" autocomplete="off" class="config i_adminpasswd" name="NewPassword2" id="dlgNewPassword2" maxlength="63" equals="dlgNewPassword" realname="<? echo dict_translate("msg_passwd_verify|New password for verification"); >">
		</td>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
