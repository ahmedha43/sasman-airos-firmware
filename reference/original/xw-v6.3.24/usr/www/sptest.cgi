...
<link href="/251204.1815/speedtest.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" language="javascript" src="/251204.1815/sptest.js"></script>
				...
				<tr>
						...
						<table cellspacing="0" cellpadding="0" class="st_opt">
							<tr>
								...
								<td>
									...
									<img id="ip_refresh" src="/251204.1815/images/refresh.png" width="16" height="16">
								</td>
							</tr>
							<tr>
								<td class="f">&nbsp;</td>
					...
					<td id="st_results">
						...
						<span id="loader" style="display: none; padding: 2px;">
							<img src="/251204.1815/images/ajax-loader.gif" />
							<br/>
