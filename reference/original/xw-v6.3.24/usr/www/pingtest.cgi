...
<link href="/251204.1815/pingtest.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" language="javascript" src="/251204.1815/ajax.js"></script>
...
<script type="text/javascript" language="javascript" src="/251204.1815/network.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/pingtest.js"></script>
...
<body class="popup" onLoad="init();">
	<form name="pingtest" target="ping_results" enctype="multipart/form-data" action="pingtest_action.cgi" method="POST" onSubmit="_runPing(this);return false;">
		...
		<div id="pt_content">
		  ...
		  <td><select class="std_width" id="dst_addr_select" name="dst_addr_select"><option value="0"><? echo dict_translate("specify manually"); ></option></select><img id="ip_refresh" src="/251204.1815/images/refresh.png " width="16" height="16"></td>
