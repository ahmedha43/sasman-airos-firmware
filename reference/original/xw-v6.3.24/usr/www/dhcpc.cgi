...
<script type="text/javascript" language="javascript" src="/251204.1815/dhcpc.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.utils.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.tmpl.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.ui.js"></script>
</head>
...
<br>
<form enctype="multipart/form-data" action="<? echo htmlspecialchars($PHP_SELF); ?>" method="POST">
