...
<script type="text/javascript" language="javascript" src="/251204.1815/signal.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/util.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/index.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/js/jquery.cookie.js"></script>
<!--[if lte IE 8]><script type="text/javascript" src="/251204.1815/js/excanvas.js"></script><![endif]-->
<script type="text/javascript" src="/251204.1815/js/jquery.flot.js"></script>
<script type="text/javascript" language="javascript" src="/251204.1815/common.js"></script>
...
<script type="text/javascript" src="/251204.1815/help.js"></script>
<? flush(); >
...
<br>
	<table border="0" cellpadding="0" cellspacing="0" class="linktable">
	  ...
	  <td valign="top"  style="width: 50%">
		<div class="fieldset" id="hwinfo">
		  <div class="row">
			<span class="label"><? echo dict_translate("CPU"); >:</span>
			<span class="value">
			  <span class="percentborder switchable"><div id="cpubar" class="hwbar">&nbsp;</div></span>
		  ...
		  <div class="row">
			<span class="label"><? echo dict_translate("Memory"); >:</span>
			<span class="value">
			  <span class="percentborder switchable"><div id="membar" class="hwbar">&nbsp;</div></span>
			  <span class="switchable">&nbsp;</span>
			  <span id="memory">&nbsp;<</span>
			  <span>&nbsp;%</span>
			</span>
		...
		<div class="fieldset"/>
		<div id="unms_info" class="row">
			<span class="label"><? echo dict_translate("UNMS"); >: <span class="help"><a id="unms_qm" href="<? echo localize_help("unms.html");>" rel="help">[?]</a></span></span>
			<span class="value">
			<span id="unms_status">&nbsp;</span>
			<span>&nbsp;</span>
			</span>
		</div>
	   </td>
	...
	id="fwall"><a href="#" id="a_fw" target="extraFrame"><? echo dict_translate("Firewall"); ></a> | </span><span
	...
	id="nolinfo" class="all"><a href="nolinfo.cgi" target="extraFrame"><? echo dict_translate("DFS Events"); ></a> | </span><span
           ...
           <td colspan="2">
           	<table cellpadding="0" align="center" cellspacing="0" width="100%">
                <tr>
	           	...
	           	<td height="10" class="foottext">
				<? include("lib/legal.inc"); echo legal_footer(); ?><br>
				<? echo dict_translate($oem_copyright); >
			</td>
                </tr>
                </table>
           </td>
